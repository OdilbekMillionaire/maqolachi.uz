import { Document, Paragraph, TextRun, Packer, AlignmentType, PageBreak, TabStopPosition, TabStopType, Header, Footer } from 'docx';
        ...
        default: new Header({
          children: [
            new Paragraph({
              children: [
                new TextRun({
                  text: `${data.domain.toUpperCase()} | ${data.academicLevel.toUpperCase()} | MAQOLACHI.UZ`,
                  size: 18,
                  font: 'Times New Roman',
                  color: '888888',
                }),
        ...
        default: new Footer({
          children: [
            new Paragraph({
              children: [
                new TextRun({
                  text: "Generated by Maqolachi.uz - Professional Academic Writing Platform",
                  size: 16,
                  font: 'Times New Roman',
                  color: 'AAAAAA',
                }),
